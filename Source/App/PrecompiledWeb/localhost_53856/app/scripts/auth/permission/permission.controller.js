    ...
    .controller("PermissionController", [
        ...
        function ($scope, urlService, authHttpService, alertService) {
            ...
            $scope.loadResources = function() {
                $scope.promise = authHttpService.get(urlService.ResourceUrls.GetPrivateResources).then(function (data) {
                    console.log(data);
            ...
            $scope.save = function() {
                if ($scope.selectedRole === "") alertService.showAlert(alertService.alertType.warning, "Please select a role first", true);
                    ...
                    $scope.createList();
                    $scope.promise = authHttpService.add(urlService.PermissionUrls.CreatePermissions, $scope.list).then(function (data) {
                        console.log(data);
            ...
            $scope.loadRolePermissions = function(role) {
                ...
                $scope.promise = authHttpService.getByParams(urlService.PermissionUrls.GetListById, { request: role.Id }).then(function (data) {
                    console.log(data);
